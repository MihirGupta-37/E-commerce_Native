...
const Login = () => {
    ...
    return (
        <View style = {styles.container}>
            <View style = {styles.header}><Text style = {styles.headerMain}>Account Login</Text>
            ...
            <View style = {styles.inputContainer}>
                ...
                autoCorrect = {false}
                value ={password}
                onChangeText={(storedata) => setPaassword(storedata)}
                />
            </View>

            <View style ={styles.buttonContainer}>
            <Pressable><Text style ={styles.pressableBtn} onPress={() => submitData()}>Login</Text></Pressable>
            </View>
        </View>
    )
}
